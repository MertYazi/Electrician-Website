...
<form method="POST" action="/admin/services/{{ $service->service_slug }}" enctype="multipart/form-data">
  @csrf
  @method('PUT')

  <div class="form-row">
    <div class="form-group col-md-12">
      <label class="text-orange" for="service_title"><b>Service Title</b> </label>
    ...
    <div class="form-group col-md-12">
      <label class="text-orange" for="service_description"><b>Service Description</b> </label>
    ...
    <div class="form-group col-md-12">
      <label class="text-orange" for="service_text"><b>Service Text</b> </label>
    ...
    <div class="form-group col-md-12">
      <label class="text-orange" for="service_importance"><b>Service Importance</b> </label>
    ...
    <div class="form-group col-md-12">
      <label class="text-orange" for="service_image"><b>Service Image</b> </label>
    ...
    <div class="form-group col-md-12">
      <label class="text-orange" for="service_cover"><b>Service Cover</b> </label>
